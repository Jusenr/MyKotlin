        ...
        if (null != this.gridView) {
            ...
            this.gridView.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> gridView, View view, int position, long id) {
                    ...
                    switch (position) {
                        case FILE_CHOOSER: {
                            intent = new Intent(TencentX5Activity.this, FilechooserActivity.class);
                            TencentX5Activity.this.startActivity(intent);

                        }
                        break;
                        case FULL_SCREEN_VIDEO: {
                            intent = new Intent(TencentX5Activity.this, FullScreenActivity.class);
                            TencentX5Activity.this.startActivity(intent);
                        }
                        break;
                        case JAVA_TO_JS: {
                            intent = new Intent(TencentX5Activity.this, JavaToJsActivity.class);
                            TencentX5Activity.this.startActivity(intent);

                        }
                        break;
//                        case TBS_COOKIE: {
//                            intent = new Intent(TencentX5Activity.this, CookieTestActivity.class); //
//                            TencentX5Activity.this.startActivity(intent);
...
//                        break;
                        case TBS_VIDEO: {
                            TencentX5Activity.this.invokeTbsVideoPlayer(
                                    "http://125.64.133.74/data9/userfiles/video02/2014/12/11/2796948-280-068-1452.mp4");

                        }
                        break;
                        case TBS_WEB: {
                            intent = new Intent(TencentX5Activity.this, BrowserActivity.class);
                            TencentX5Activity.this.startActivity(intent);

                        }
                        break;
                        case TBS_IMAGE: {
                            intent = new Intent(TencentX5Activity.this, ImageResultActivity.class);
                            TencentX5Activity.this.startActivity(intent);

                        }
                        break;
                        case SYS_WEB: {
                            intent = new Intent(TencentX5Activity.this, SystemWebActivity.class);
                            TencentX5Activity.this.startActivity(intent);

                        }
                        break;
                        case TBS_FLASH: {
                            intent = new Intent(TencentX5Activity.this, FlashPlayerActivity.class);
                            TencentX5Activity.this.startActivity(intent);
                        ...
                        case TBS_NEW_WINDOW: {
                            intent = new Intent(TencentX5Activity.this, WebViewTransportActivity.class);
                            TencentX5Activity.this.startActivity(intent);
                        ...
                        case TBS_LONG_PRESS: {
                            intent = new Intent(TencentX5Activity.this, MyLongPressActivity.class);
                            TencentX5Activity.this.startActivity(intent);

                        }
                        break;
                        case TBS_OVER_SCROLL: {
                            intent = new Intent(TencentX5Activity.this, RefreshActivity.class);
                            TencentX5Activity.this.startActivity(intent);
